      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-2xl p-8 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              onClick={onRestart}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-6 rounded-lg transition duration-200 transform hover:scale-105 cursor-pointer"
            >
              Mulai Quiz Baru
            </button>
            <button
              onClick={onLogout}
              className="w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-4 px-6 rounded-lg transition duration-200 transform hover:scale-105 cursor-pointer"
            >
              Logout
            </button>
          </div>
